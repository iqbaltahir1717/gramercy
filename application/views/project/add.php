                                            ...
                                            <div class="col-lg-5">
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3 form-group">
                                                        ...
                                                        <input type="file" class="form-control" placeholder="Cover/Thumbnail Unit" name="project_cover" accept=".png, .jpeg, .jpg" required="required">
                                                    </div>
                                                    <div class="mb-3 form-group">
                                                        <label for="project_description" class="mb-2">Description</label>
                                                        <textarea class="form-control" name="project_description" placeholder="Enter Description" rows="5" required="required"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
