    <main id="main">
        <section id="news1" class="news1" style="background: linear-gradient(90deg, #FFF 26.56%, rgba(255, 255, 255, 0.83) 50.75%, rgba(255, 255, 255, 0.00) 70.23%), url(<?= base_url()."/upload/news/".$news[0]->news_cover.")"?> no-repeat center center fixed; background-size: cover; width: 100%;">
            <div class="container">
                <div class="unitimg">
                    <div class="unittext">
                                ...
                                <article class="entry" >
                                    ...
                                    <div class="entry-meta" style="color:#777777;font-size:12px;">
                                        <ul>
                                            ...
                                            <li class="d-flex align-items-center"> <i class="icofont-eye-alt"></i> <b><?php echo indonesiaDate($n->news_count_view)?>x Views</b></li>
                                ...
                                <div class="sidebar">
                                    ...
                                    <div class="sidebar-item recent-posts">
                                        ...
                                        <div class="post-item clearfix">
                                            ...
                                            <time style="color:gray"><i class="icofont-eye-alt"></i> <?php echo $r->news_count_view;?>x Views&nbsp;&nbsp;<b class="badge badge-success"><?php echo $r->field_name;?></b></time>
                                        </div>
                                        <?php } ?>
                                    </div>
                                </div>
