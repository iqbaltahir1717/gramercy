<main id="mainsiteplan">
    <section id="siteplan1" class="siteplan1" style="background:url(<?= base_url()."/upload/siteplan/". $siteplan[0]->siteplan_image1 ?>) no-repeat center center fixed; background-size: cover; width: 100%;">
        <div class="container">
            <div class="row">
                <div class="unitimg">
    ...
    <section id="siteplan3" class="siteplan3" style="background:url(<?= base_url()."/upload/siteplan/". $siteplan[0]->siteplan_image2 ?>) no-repeat center center fixed; background-size: cover; width: 100%">
        <div class="container">
            <div class="row">
                <div class="unitimg">
                    <div class="row mouser mr-5 justify-content-end">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="row dev">
                        <a href="<?php echo site_url('developer'); ?>"><button type="button">About Developers <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
