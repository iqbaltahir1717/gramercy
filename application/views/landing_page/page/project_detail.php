...
<main id="mainunittype">
    <section id="unittype1" class="unittype1" style="background: linear-gradient(180deg, rgba(0, 0, 0, 0.00) 39.24%, #000 91.32%), linear-gradient(180deg, #000 8.67%, rgba(0, 0, 0, 0.00) 53.35%), url(<?= base_url()."/upload/project/".$project[0]->project_cover.")"?> no-repeat center center fixed; background-size: cover; width: 100%;">
        <div class="container">
            <div class="row">
                <div class="unitimg">
                    <div class="unittext">
                ...
                <div class="row align-items-center mb-4 flex-wrap" style="gap: 10px;">
                    ...
                    <div class="gallery-feed">
                        <div class="card-gallery">
                                <img src="<?= base_url()."/upload/project/". $project[0]->project_cover?>">
                                <a href="<?= base_url()."/upload/project/". $project[0]->project_cover?>" class="overlay glightbox" data-zoomable="true">
                                    <h2>See Photos</h2>
                                    </a>
                            </div>
