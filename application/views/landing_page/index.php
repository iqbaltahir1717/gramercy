...
<script src="<?= base_url('vendor/twbs/bootstrap/dist/js/bootstrap.min.js') ?>"></script>
    <main id="main mt-5">
    <section id="hero-new" class="hero-new mt-5">
        ...
        <div class="container baristwo md-12 mt-3">
            <div class="row align-items-center">
                <div class="col-md-6">
        ...
        <div class="container baristree md-12 mt-3">
            <div class="row align-items-center">
                <div class="col-md-12 justify-content-end">
                    <h1 class="bannertext">EXCLUSIVE  DREAMS</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- --------------------------Section 3----------------------------------- -->
    <section id="hero-new3" class="hero-new3 mt-0">
    ...
    <section id="hero-new4" class="hero-new4 mt-0">
        ...
        <section id="blog" class="blog" style="background-color: #f1f8ff">
            <div class="container" data-aos="fade-up">
                <div class="section-title">
                    ...
                    <p>Kumpulan berita yang selalu up-to-date</p>
                </div>
                <div class="row">
        ...
        <section id="portfolio" class="portfoio" style="background-color: #f1f8ff;">
            <div class="container" data-aos="fade-up">
                <div class="section-title">
                    <h2>GALERI</h2>
                    <p>Kumpulan Galeri Foto dari berbagai tanggal dan momen berbeda</p>
                </div>
        ...
        <section id="contact" class="contact">
            <div class="container-fluid" data-aos="fade-up">
                <div class="section-title">
                    <h2>HUBUNGI KAMI</h2>
                    <p>Jika memiliki pertanyaan atau sesuatu mengenai Puskesmas Mekar, silahkan mengisi form dibawah agar kami <br>tahu mengenai apa yang ingin kamu ketahui lebih dari kami. Atas perhatianmu kami ucapkan Terimakasih</p>
                </div>
