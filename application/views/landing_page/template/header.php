...
<html lang="en">
	<head>
		...
		<meta name="keywords" content="Puskesmas Mekar, Dinas Kesehatan sultra, <?php echo $setting[0]->setting_appname;?>, <?php echo $setting[0]->setting_owner_name;?>">
		<meta name="robots" content="index, nofollow">
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		<meta name="author" content="<?php echo $setting[0]->setting_owner_name;?>">

		<!-- Favicons -->
		<link href="<?php echo base_url();?>assets/core-images/puskesmas.png" rel="icon">
		<link href="<?php echo base_url();?>assets/core-images/puskesmas.png" rel="apple-touch-icon">
		<!-- Google Fonts -->
		...
		<link href="<?php echo base_url()?>assets/landing_page/vendor/icofont/icofont.min.css" rel="stylesheet">
		<link href="<?php echo base_url()?>assets/landing_page/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
		<link href="<?php echo base_url()?>assets/landing_page/vendor/animate.css/animate.min.css" rel="stylesheet">
		<link href="<?php echo base_url()?>assets/landing_page/vendor/remixicon/remixicon.css" rel="stylesheet">
