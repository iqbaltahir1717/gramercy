                                    ...
                                    <form>
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <input type="file" class="form-control" name="optical_cover" required="required" accept=".png, .jpeg, .jpg">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                            ...
                                                            <form>
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-12">
                                                                            <div class="form-group">
                                                                                <input type="file" class="form-control" name="optical_cover" accept=".png, .jpeg, .jpg">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
