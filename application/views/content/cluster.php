                                    ...
                                    <form>
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    <div class="form-group">
                                                        <input type="file" class="form-control" name="cluster_cover" required="required" accept=".png, .jpeg, .jpg">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                            ...
                                                            <form>
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-9">
                                                                            <div class="form-group">
                                                                                <input type="file" class="form-control" name="cluster_cover" accept=".png, .jpeg, .jpg">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
