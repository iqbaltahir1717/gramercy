                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3 form-group">
                                                ...
                                                <input type="file" class="form-control" placeholder="Cover/Thumbnail Unit" name="siteplan_image1" accept=".png, .jpeg, .jpg">
                                            </div>
                                            <div class="mb-3 form-group">
                                                <label for="siteplan_image1_description" class="mb-2">Descrpiton Image Siteplan 1</label>
                                                <textarea class="form-control" name="siteplan_image1_description" placeholder="Enter Description" rows="7"><?php echo $siteplan[0]->siteplan_image1_description;?></textarea>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3 form-group">
                                                ...
                                                <input type="file" class="form-control" placeholder="Cover/Thumbnail Unit" name="siteplan_image2" accept=".png, .jpeg, .jpg">
                                            </div>
                                            <div class="mb-3 form-group">
                                                <label for="siteplan_image2_description" class="mb-2">Descrpiton Image Siteplan 2</label>
                                                <textarea class="form-control" name="siteplan_image2_description" placeholder="Enter Description" rows="7"><?php echo $siteplan[0]->siteplan_image2_description;?></textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3 form-group">
                                                ...
                                                <textarea class="form-control" name="siteplan_cluster" placeholder="Enter Description" rows="7"><?php echo $siteplan[0]->siteplan_cluster;?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3 form-group">
                                                <label for="siteplan_optical" class="mb-2">Optimal Strategic Layout</label>
                                                <textarea class="form-control" name="siteplan_optical" placeholder="Enter Description" rows="7"><?php echo $siteplan[0]->siteplan_optical;?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </form>
