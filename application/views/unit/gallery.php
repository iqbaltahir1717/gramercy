                                    ...
                                    <form>
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    <div class="form-group">
                                                        <input type="file" class="form-control" name="gallery_image" required="required" accept=".png, .jpeg, .jpg">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                            ...
                                                            <form>
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-9">
                                                                            <div class="form-group">
                                                                                <input type="file" class="form-control" name="gallery_image" accept=".png, .jpeg, .jpg">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
