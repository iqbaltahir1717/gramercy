                                            ...
                                            <div class="col-lg-5">
                                                <div class="row">
                                                    <div class="mb-3 form-group">
                                                        ...
                                                        <input type="file" class="form-control" placeholder="Cover/Thumbnail Unit" name="unit_preview1" accept=".png, .jpeg, .jpg" required="required">
                                                    </div>
                                                    <div class="mb-3 form-group">
                                                        <label for="unit_name" class="mb-2">Image 2 (maxsize 2MB)</label>
                                                        <input type="file" class="form-control" placeholder="Cover/Thumbnail Unit" name="unit_preview2" accept=".png, .jpeg, .jpg" required="required">
                                                    </div>
                                                    <div class="mb-3 form-group">
                                                        <label for="unit_description" class="mb-2">Description</label>
                                                        <textarea class="form-control" name="unit_description" placeholder="Enter Description" rows="5" required="required"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
