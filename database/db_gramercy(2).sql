...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Okt 2023 pada 03.02
...
(4, 'Alca Room', 'gallery-7-20231021124612.jpg', 'tes', 7, 2, '2023-10-21 04:46:12');
...
(1, 'Armas', '4+1', '5+1', '569', 'Never Underestimate the power of dreams and the influencer of the human spiriti. the quote inspired design of the 569 sqm ARMA with 5+1 bedrooms, 6+1 luxury  bathrooms. We support the power of imagination in creating a meaningful life. Available in two designs, the Arma and Arma Corner.', 'arma1.jpg', 'arma2.jpg', '2023-10-23 01:21:34', '2023-10-22 17:21:34');
...
--
ALTER TABLE `tbl_optical_layout`
  MODIFY `optical_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `tbl_project`
--
ALTER TABLE `tbl_project`
  MODIFY `project_id` int(24) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `tbl_project_gallery`
--
ALTER TABLE `tbl_project_gallery`
  MODIFY `project_gallery_id` int(24) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `tbl_unit`
  MODIFY `unit_id` int(24) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
